...
spanish_voice = next((voice for voice in voices if "spanish" in voice.languages), None)

if spanish_voice is not None:
    engine.setProperty('voice', spanish_voice.id)
else:
    print("No se encontró una voz en español. Utilizando la voz predeterminada.")
